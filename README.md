# Bootstrap Dual Listbox [![Build Status](https://secure.travis-ci.org/frapontillo/bootstrap-duallistbox.png?branch=master)](https://travis-ci.org/frapontillo/bootstrap-duallistbox)
